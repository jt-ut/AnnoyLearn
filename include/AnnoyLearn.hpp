#ifndef ANNOYLEARN_ANNOYLEARN_HPP
#define ANNOYLEARN_ANNOYLEARN_HPP

#include "AnnoyRecall.hpp"
...
#pragma omp parallel for
  ...
  void train() {
    ...
    // progressbar bar(n_epochs);
    // bar.set_todo_char(" ");
    // bar.set_done_char("=");
    // bar.set_opening_bracket_char("NG Learn [");
